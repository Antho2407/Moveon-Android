...
public class ExecTask extends
	...
	/*
	 * Cette méthode est exécutée dans son propre thread. C'est là où le travail
	 * le plus lourd se passe. On pourra appeler publishProgress durant
	 * l'exécution de cette méthode pour mettre à jour le thread d'interface.
	 */
	...
	/*
	 * Cette méthode s'exécute dans le thread d'interface. C'est l'endroit où on
	 * réagit généralement à la complétion du processus en arrière-plan, par
	 * exemple en mettant à jour l'interface avec les données obtenues.
	 */
